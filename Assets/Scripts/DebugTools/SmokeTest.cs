...
{
    /// <summary>
    /// TEMPORARY: verifies content ScriptableObject wiring. Set the three fish IDs in the inspector to any
    /// three fish from the FishDatabase. Delete after acceptance criteria pass.
    /// </summary>
